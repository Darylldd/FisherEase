...
// Configure SendGrid (store your key in .env for security)
...
async function sendEmail(to, subject, html, text) {
    const msg = {
        to,
        from: '"FMO Support" <no-reply@fmo-app.com>', // Change this in SendGrid verified sender
        subject,
        text,
        html
    };
